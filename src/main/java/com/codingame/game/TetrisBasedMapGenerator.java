...
public class TetrisBasedMapGenerator {
    ...
    public void generateWithHorizontalSymmetry(Grid grid, Random random) {
    ...
    public void generateWithCentralSymmetry(Grid grid, Random random) {
        int w = grid.getWidth() / 2 + 1;
