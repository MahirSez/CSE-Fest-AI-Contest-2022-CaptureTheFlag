/**
 * All the minions move about, collecting the first coin that it
 * sees. WHen no coin is visible, everyone simply waits. They don't
 * capture flag
 */
...
public class Waiter_with_more_score {
